<div class="container">
	...
	<div class="row">
		<div class="col-xs-12 col-sm-4">
			<div class="thumbnail">
				<img alt="${product.name}" src="${images}/${product.code}.jpg"
					class="img img-responsive" width="300px" height="300px">
			</div>
		</div>
		<div class="col-xs-12 col-sm-8">
			...
			<a href="${contextRoot}/show/all/products" class="btn btn-danger"><span
				class="glyphicon glyphicon-open-eye"></span>Back</a>
		</div>
	</div>
</div>